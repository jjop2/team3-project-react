...
const Sports = () =>{
    ...
    axiosInstance.get(`${import.meta.env.VITE_SERVER_URL}/recommendgame/genre/4`)
    .then(response =>{
  ...
  return (
    <div>
      <div className="list_banner sports_banner">
        <div className="banner_cover">
          {gameList.length > 0 ? (
            <h1 className="list_title">
              Sports <span className="list_subtitle">장르를 좋아하는 당신을 위한 </span>게임 추천
            </h1>
          ) : (
            ""
          )}
