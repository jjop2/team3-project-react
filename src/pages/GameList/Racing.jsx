...
const Racing = () =>{
    ...
    axiosInstance.get(`${import.meta.env.VITE_SERVER_URL}/recommendgame/genre/3`)
    .then(response =>{
  ...
  return (
    <div>
      <div className="list_banner racing_banner">
        <div className="banner_cover">
          {gameList.length > 0 ? (
            <h1 className="list_title">
              Racing <span className="list_subtitle">장르를 좋아하는 당신을 위한 </span>게임
              추천
            </h1>
          ) : (
            ""
